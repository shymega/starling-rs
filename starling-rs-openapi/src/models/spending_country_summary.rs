...
/// SpendingCountrySummary : Spending insights for a month, grouped by spending country

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct SpendingCountrySummary {
    #[serde(
        rename = "period",
    ...
    pub breakdown: Option<Vec<crate::models::SpendingCountryBreakdown>>,
}

impl SpendingCountrySummary {
    /// Spending insights for a month, grouped by spending country
    pub fn new() -> SpendingCountrySummary {
