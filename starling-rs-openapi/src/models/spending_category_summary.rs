...
pub struct SpendingCategorySummary {
    #[serde(
        rename = "period",
    ...
    pub breakdown:
        Option<Vec<crate::models::SpendingCategoryBreakdown>>,
}

impl SpendingCategorySummary {
    /// Spending insights for a month, grouped by spending category
    pub fn new() -> SpendingCategorySummary {
