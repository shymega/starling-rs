...
pub struct ReceiptTaxDetail {
    #[serde(
        rename = "receiptTaxDetailUid",
        skip_serializing_if = "Option::is_none"
    )]
    pub receipt_tax_detail_uid: Option<String>,
    #[serde(rename = "taxName")]
    pub tax_name: String,
    #[serde(rename = "taxValue")]
    pub tax_value: f32,
    #[serde(rename = "taxCurrencyCode")]
    pub tax_currency_code: TaxCurrencyCode,
...
impl Default for TaxCurrencyCode {
    fn default() -> TaxCurrencyCode {
        Self::UNDEFINED
    }
}
