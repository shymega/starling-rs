...
pub struct UpdateSpendingCategory {
    /// The category of a transaction
    #[serde(rename = "spendingCategory")]
    pub spending_category: SpendingCategory,
    #[serde(
        rename = "permanentSpendingCategoryUpdate",
        skip_serializing_if = "Option::is_none"
    )]
    pub permanent_spending_category_update: Option<bool>,
    #[serde(
        rename = "previousSpendingCategoryReferencesUpdate",
        skip_serializing_if = "Option::is_none"
    )]
    pub previous_spending_category_references_update: Option<bool>,
}

impl UpdateSpendingCategory {
    pub fn new(
        spending_category: SpendingCategory,
    ) -> UpdateSpendingCategory {
        UpdateSpendingCategory {
            spending_category,
            permanent_spending_category_update: None,
            previous_spending_category_references_update: None,
        }
    }
}
