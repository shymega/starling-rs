...
/// AddressRequest : Account holder's previous address history, 6 month minimum

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(tag = "addressformat")]
pub enum AddressRequest {
    #[serde(rename = "UkManualAddressRequest")]
    UkManualAddressRequest {
        ...
        dependant_thoroughfare: Option<String>,
        #[serde(
            rename = "dependantLocality",
            skip_serializing_if = "Option::is_none"
        )]
        dependant_locality: Option<String>,
        #[serde(
            rename = "doubleDependantLocality",
            skip_serializing_if = "Option::is_none"
        )]
        double_dependant_locality: Option<String>,
        #[serde(
            rename = "county",
            skip_serializing_if = "Option::is_none"
        )]
    ...
    #[serde(rename = "UkPafAddressRequest")]
    UkPafAddressRequest {
        #[serde(rename = "postcode")]
        postcode: String,
        #[serde(rename = "postTown")]
